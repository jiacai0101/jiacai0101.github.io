...
const PROFILE: Record<Lang, ProfileData> = {
    en: {
        ...
        platforms: [
            ...
            { name: "DrugStudio", description: "One-stop platform for molecular modeling and scientific workflows; vNext moving to a problem-driven workbench." },
            { name: "AIDD Brief", description: "Bilingual daily briefing on AI-driven drug discovery.", url: "https://brief.minddanceai.com" },
            { name: "AIDD Idea Atlas", description: "100 citable research proposals on AI opportunities in drug discovery.", url: "https://aiddea.minddanceai.com" },
        ],
    ...
    zh: {
        ...
        platforms: [
            ...
            { name: "DrugStudio", description: "面向分子建模与科研工作流的一站式平台；vNext 正转向问题驱动工作台。" },
            { name: "AIDD Brief", description: "面向 AI 药物发现的双语每日简报。", url: "https://brief.minddanceai.com" },
            { name: "AIDD Idea Atlas", description: "100 个 AI 药物发现研究立项机会。", url: "https://aiddea.minddanceai.com" },
        ],
        email: "yjc0101@hkbu.edu.hk",
        location: "香港",
        cvUrl: "/cv",
