...
export const SITE: SiteConfig = {
    website: "https://jiacai0101.github.io/",
    author: "Jiacai Yi",
    desc: "Personal academic homepage of Jiacai Yi — postdoctoral researcher in AI-enabled drug design and biomedical AI platforms at Hong Kong Baptist University.",
    title: "Jiacai Yi",
    ogImage: "og.webp",
    postPerPage: 8,
    favicon: "/favicon.svg",
